...
This file contains all scripts and configs required to recreate the dual arm IL visuomotor environment.
...
## `models/diffusion/diffusion_policy.py`
...
## `scripts/generate_scripted_demos_parallel_modified.py`
