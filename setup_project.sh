...
cat << 'EOF_FILE' > configs/act_cfg.yaml
...
cat << 'EOF_FILE' > configs/bc_cfg.yaml
...
cat << 'EOF_FILE' > configs/diffusion_cfg.yaml
...
cat << 'EOF_FILE' > configs/env_cfg.py
...
cat << 'EOF_FILE' > dataset/il_dataset.py
# Copyright (c) 2026, Dual Arm Imitation Learning Project.
# SPDX-License-Identifier: BSD-3-Clause
...
cat << 'EOF_FILE' > models/__init__.py
# Copyright (c) 2026, Dual Arm Imitation Learning Project.
# SPDX-License-Identifier: BSD-3-Clause
...
cat << 'EOF_FILE' > models/act/__init__.py
# Copyright (c) 2026, Dual Arm Imitation Learning Project.
# SPDX-License-Identifier: BSD-3-Clause
...
cat << 'EOF_FILE' > models/act/act_policy.py
# Copyright (c) 2026, Dual Arm Imitation Learning Project.
# SPDX-License-Identifier: BSD-3-Clause
...
cat << 'EOF_FILE' > models/act/transformer.py
# Copyright (c) 2026, Dual Arm Imitation Learning Project.
# SPDX-License-Identifier: BSD-3-Clause
...
cat << 'EOF_FILE' > models/bc/__init__.py
# Copyright (c) 2026, Dual Arm Imitation Learning Project.
# SPDX-License-Identifier: BSD-3-Clause
...
cat << 'EOF_FILE' > models/bc/bc_policy.py
# Copyright (c) 2026, Dual Arm Imitation Learning Project.
# SPDX-License-Identifier: BSD-3-Clause
...
cat << 'EOF_FILE' > models/diffusion/__init__.py
# Copyright (c) 2026, Dual Arm Imitation Learning Project.
# SPDX-License-Identifier: BSD-3-Clause
...
cat << 'EOF_FILE' > models/diffusion/diffusion_policy.py
# Copyright (c) 2026, Dual Arm Imitation Learning Project.
# SPDX-License-Identifier: BSD-3-Clause
...
cat << 'EOF_FILE' > models/diffusion/unet1d.py
# Copyright (c) 2026, Dual Arm Imitation Learning Project.
# SPDX-License-Identifier: BSD-3-Clause
...
cat << 'EOF_FILE' > models/vision_encoder.py
import torch
import torch.nn as nn
...
cat << 'EOF_FILE' > scripts/eval_parallel.py
import argparse
import collections
import os
import sys
...
cat << 'EOF_FILE' > scripts/generate_scripted_demos.py
# Copyright (c) 2026, Dual Arm Imitation Learning Project.
# SPDX-License-Identifier: BSD-3-Clause
...
cat << 'EOF_FILE' > scripts/generate_scripted_demos_parallel.py
# Copyright (c) 2026, Dual Arm Imitation Learning Project.
# SPDX-License-Identifier: BSD-3-Clause
...
cat << 'EOF_FILE' > scripts/generate_scripted_demos_parallel_modified.py
# Copyright (c) 2026, Dual Arm Imitation Learning Project.
# SPDX-License-Identifier: BSD-3-Clause
...
cat << 'EOF_FILE' > scripts/replay_demos.py
# Copyright (c) 2026, Dual Arm Imitation Learning Project.
# SPDX-License-Identifier: BSD-3-Clause
...
cat << 'EOF_FILE' > teleop/collect_demos.py
# Copyright (c) 2026, Dual Arm Imitation Learning Project.
# SPDX-License-Identifier: BSD-3-Clause
...
cat << 'EOF_FILE' > teleop/dual_arm_teleop.py
# Copyright (c) 2026, Dual Arm Imitation Learning Project.
# SPDX-License-Identifier: BSD-3-Clause
