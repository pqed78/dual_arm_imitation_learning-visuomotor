...
echo 'Created configs/env_cfg.py'

cat << 'EOF' > configs/bc_cfg.yaml
...
echo 'Created configs/bc_cfg.yaml'

cat << 'EOF' > configs/diffusion_cfg.yaml
...
echo 'Created configs/diffusion_cfg.yaml'

cat << 'EOF' > configs/act_cfg.yaml
...
echo 'Created configs/act_cfg.yaml'

cat << 'EOF' > teleop/dual_arm_teleop.py
# Copyright (c) 2026, Dual Arm Imitation Learning Project.
# SPDX-License-Identifier: BSD-3-Clause
...
echo 'Created teleop/dual_arm_teleop.py'

cat << 'EOF' > teleop/collect_demos.py
# Copyright (c) 2026, Dual Arm Imitation Learning Project.
# SPDX-License-Identifier: BSD-3-Clause
...
echo 'Created teleop/collect_demos.py'

cat << 'EOF' > dataset/il_dataset.py
# Copyright (c) 2026, Dual Arm Imitation Learning Project.
# SPDX-License-Identifier: BSD-3-Clause
...
echo 'Created dataset/il_dataset.py'

cat << 'EOF' > models/vision_encoder.py
import torch
...
echo 'Created models/vision_encoder.py'

cat << 'EOF' > scripts/generate_scripted_demos.py
# Copyright (c) 2026, Dual Arm Imitation Learning Project.
# SPDX-License-Identifier: BSD-3-Clause
...
echo 'Created scripts/generate_scripted_demos.py'

cat << 'EOF' > scripts/generate_scripted_demos_parallel.py
# Copyright (c) 2026, Dual Arm Imitation Learning Project.
# SPDX-License-Identifier: BSD-3-Clause
...
echo 'Created scripts/generate_scripted_demos_parallel.py'

cat << 'EOF' > scripts/replay_demos.py
# Copyright (c) 2026, Dual Arm Imitation Learning Project.
# SPDX-License-Identifier: BSD-3-Clause
...
echo 'Created scripts/replay_demos.py'
...
echo 'Created scripts/train.py'

cat << 'EOF' > scripts/eval.py
# Copyright (c) 2026, Dual Arm Imitation Learning Project.
# SPDX-License-Identifier: BSD-3-Clause
...
echo 'Created scripts/eval.py'

cat << 'EOF' > scripts/eval_parallel.py
import argparse
import collections
import os
import sys
...
echo 'Created scripts/eval_parallel.py'

chmod +x run_pipeline.sh setup_project.sh
